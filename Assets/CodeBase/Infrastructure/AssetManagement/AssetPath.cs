namespace CodeBase.Infrastructure.AssetManagement
{
  ...
  {
    public const string AttackTowerPath = "Gameplay/AttackTower";
    public const string RocketPath = "Gameplay/Rocket";
    public const string ExplosionPath = "Gameplay/Explosion";
